...
namespace evdEn
{
    ...
    class LoadingScreen : GameScreen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            {
                // Start up the background thread, which will draw the animation while we are loading.
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                spriteBatch.Draw(evdEnUI.loadingFrames,
                    evdEnUI.loadingDest,
                    new Rectangle(evdEnUI.loadingFrameSize.X * framesCount, 0, evdEnUI.loadingFrameSize.X, evdEnUI.loadingFrameSize.Y),
                    color);
                spriteBatch.End();
            }
        }
